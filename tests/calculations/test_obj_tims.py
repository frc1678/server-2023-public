...
class TestObjTIMCalcs:
    unconsolidated_tims = [
        {
            ...
            "timeline": [
                ...
                {"time": 15, "action_type": "score_ball_high_near_other"},
                {"time": 26, "action_type": "score_ball_low_near_hub"},
                ...
                {"time": 90, "action_type": "score_ball_high_far_hub"},
                {"time": 96, "action_type": "score_ball_low_near_hub"},
                {"time": 103, "action_type": "score_ball_high_near_hub"},
                {"time": 110, "action_type": "score_opponent_ball"},
                {"time": 111, "action_type": "score_opponent_ball"},
                {"time": 135, "action_type": "score_ball_low_far_hub"},
                {"time": 140, "action_type": "score_ball_high_far_hub"},
            ],
        ...
        },
        {
            ...
            "timeline": [
                ...
                {"time": 68, "action_type": "score_ball_high_far_other"},
                {"time": 80, "action_type": "score_ball_high_launchpad"},
                {"time": 90, "action_type": "score_ball_high_far_hub"},
                {"time": 96, "action_type": "score_ball_low_near_hub"},
                {"time": 101, "action_type": "score_ball_high_near_hub"},
                {"time": 110, "action_type": "score_opponent_ball"},
                {"time": 111, "action_type": "score_opponent_ball"},
                {"time": 112, "action_type": "score_ball_high"},
                {"time": 122, "action_type": "score_ball_high"},
                {"time": 136, "action_type": "score_ball_low_far_hub"},
                {"time": 140, "action_type": "score_ball_high_far_hub"},
            ],
            "climb_level": "HIGH",
            "start_position": "TWO"
    ...
    def test_filter_timeline_actions(self):
        ...
        assert actions == [
            ...
            {'action_type': 'score_ball_high_near_other', 'time': 15},
            {'action_type': 'score_ball_low_near_hub', 'time': 26},
            {'action_type': 'end_incap', 'time': 37},
            {'action_type': 'start_incap', 'time': 47},
            {'action_type': 'start_climb', 'time': 53},
            {'action_type': 'score_ball_high_far_other', 'time': 69},
            {'action_type': 'score_ball_high_launchpad', 'time': 80},
            {'action_type': 'score_ball_high_far_hub', 'time': 90},
            {'action_type': 'score_ball_low_near_hub', 'time': 96},
            {'action_type': 'score_ball_high_near_hub', 'time': 103},
            {'action_type': 'score_opponent_ball', 'time': 110 },
            {'action_type': 'score_opponent_ball', 'time': 111 },
            {'action_type': 'score_ball_low_far_hub', 'time': 135},
            {'action_type': 'score_ball_high_far_hub', 'time': 140},
        ]
    ...
    def test_run_consolidation(self):
        ...
        assert calculated_tim['auto_near_hub_highs'] == 0
        assert calculated_tim['auto_far_hub_highs'] == 1
        assert calculated_tim['auto_launchpad_highs'] == 0
        assert calculated_tim['auto_near_other_highs'] == 0
        assert calculated_tim['auto_far_other_highs'] == 0
        assert calculated_tim['auto_near_hub_lows'] == 0
        assert calculated_tim['auto_far_hub_lows'] == 1
        assert calculated_tim['tele_near_hub_highs'] == 1
        assert calculated_tim['tele_far_hub_highs'] == 1
        assert calculated_tim['tele_launchpad_highs'] == 1
        assert calculated_tim['tele_near_other_highs'] == 1
        assert calculated_tim['tele_far_other_highs'] == 1
        assert calculated_tim['tele_near_hub_lows'] == 2
        assert calculated_tim['tele_far_hub_lows'] == 0
        assert calculated_tim['opp_balls_scored'] == 2
        assert calculated_tim['auto_balls_low'] == 1
        assert calculated_tim['auto_balls_high'] == 1
        assert calculated_tim['tele_balls_low'] == 2
