...
class TestPredictedAimCalc:
    def setup_method(self, method):
        ...
        self.full_predicted_values = predicted_aim.PredictedAimScores(
            auto_low_balls=30.2,
            auto_high_balls=10.5,
            tele_low_balls=5.0,
            tele_high_balls=19.4,
    ...
    def test_calculate_predicted_balls_score(self):
        ...
        assert self.blank_predicted_values.auto_low_balls == 4.5
        assert self.blank_predicted_values.auto_high_balls == 7.5
        assert self.blank_predicted_values.tele_low_balls == 3.3
        assert self.blank_predicted_values.tele_high_balls == 16.1
        self.test_calc.calculate_predicted_balls_score(
            self.blank_predicted_values, self.obj_team[1]
        )
        assert self.blank_predicted_values.auto_low_balls == 8.2
        assert self.blank_predicted_values.auto_high_balls == 15.7
        assert self.blank_predicted_values.tele_low_balls == 6.0
        assert self.blank_predicted_values.tele_high_balls == 43.5
        self.test_calc.calculate_predicted_balls_score(
            self.blank_predicted_values, self.obj_team[2]
        )
        assert self.blank_predicted_values.auto_low_balls == 11.7
        assert round(self.blank_predicted_values.auto_high_balls, 1) == 22.1
        assert self.blank_predicted_values.tele_low_balls == 9.8
        assert self.blank_predicted_values.tele_high_balls == 47.4
