...
class TestOBJTeamCalc:
    ...
    def test_averages(self):
        ...
        expected_output = {
            ...
            "avg_intakes_double": 8.8,
            "avg_intakes_single": 5.8,
            "avg_intakes_low_row": 9.8,
            "avg_intakes_mid_row": 7.6,
            "avg_intakes_high_row": 7.6,
            ...
            "lfm_avg_intakes_double": 10.0,
            "lfm_avg_intakes_single": 5.0,
            "lfm_avg_intakes_low_row": 11.0,
            "lfm_avg_intakes_mid_row": 9.0,
            "lfm_avg_intakes_high_row": 9.0,
    ...
    def test_counts(self):
        ...
        expected_output = {
            ...
            "lfm_auto_dock_only_successes": 1,
            "lfm_auto_dock_successes": 3,
    ...
    def test_extrema(self):
        ...
        expected_output = {
            ...
            "max_incap": 90,
            "max_auto_charge_level": "E",
            "max_tele_charge_level": "E",
    ...
    def test_modes(self):
        ...
        assert self.test_calc.calculate_modes(action_categories, lfm_action_categories) == {
            "mode_preloaded_gamepiece": ["O"],
            "mode_start_position": ["1", "2", "3"],
            "lfm_mode_start_position": ["3"],
            "mode_auto_charge_level": ["D"],
            "lfm_mode_auto_charge_level": ["D"],
            "mode_tele_charge_level": ["D"],
            "lfm_mode_tele_charge_level": ["D"],
        }
        ...
        expected_results = [
            {
                ...
                "avg_intakes_double": 13.333333333333334,
                "avg_intakes_single": 2.0,
                "avg_intakes_low_row": 8.333333333333334,
                "avg_intakes_mid_row": 4.0,
                "avg_intakes_high_row": 4.0,
                ...
                "lfm_avg_intakes_double": 13.333333333333334,
                "lfm_avg_intakes_single": 2.0,
                "lfm_avg_intakes_low_row": 8.333333333333334,
                "lfm_avg_intakes_mid_row": 4.0,
                "lfm_avg_intakes_high_row": 4.0,
                ...
                "auto_dock_only_successes": 1,
                "auto_dock_successes": 3,
                "auto_engage_successes": 2,
                "tele_charge_attempts": 3,
                "tele_dock_only_successes": 0,
                "tele_dock_successes": 2,
                "tele_engage_successes": 2,
                ...
                "lfm_auto_engage_successes": 2,
                "lfm_tele_charge_attempts": 3,
                "lfm_tele_dock_only_successes": 0,
                "lfm_tele_dock_successes": 2,
                ...
                "mode_auto_charge_level": ["E"],
                "mode_tele_charge_level": ["E"],
                # LFM Modes
                "lfm_mode_start_position": ["1"],
                "lfm_mode_auto_charge_level": ["E"],
                "lfm_mode_tele_charge_level": ["E"],
                # Medians
                "median_nonzero_incap": 20,
                # LFM Medians
            ...
            },
            {
                ...
                "avg_intakes_double": 30.4,
                "avg_intakes_single": 6.0,
                "avg_intakes_low_row": 14.4,
                "avg_intakes_mid_row": 0.2,
                "avg_intakes_high_row": 0.4,
                ...
                "lfm_avg_intakes_double": 29.25,
                "lfm_avg_intakes_single": 6.5,
                "lfm_avg_intakes_low_row": 15.0,
                "lfm_avg_intakes_mid_row": 0.25,
                "lfm_avg_intakes_high_row": 0.25,
                ...
                "auto_dock_successes": 5,
                "auto_engage_successes": 3,
                "tele_charge_attempts": 5,
                "tele_dock_only_successes": 2,
                ...
                "lfm_auto_dock_only_successes": 2,
                ...
                "mode_start_position": ["1"],
                "mode_auto_charge_level": ["E"],
                "mode_tele_charge_level": ["D", "E"],
                # LFM Modes
                "lfm_mode_start_position": ["1"],
                "lfm_mode_auto_charge_level": ["E", "D"],
                "lfm_mode_tele_charge_level": ["E"],
                # Medians
                "median_nonzero_incap": 21,
                # LFM Medians
