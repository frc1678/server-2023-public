...
class TestOBJTeamCalc:
    ...
    def test_averages(self):
        ...
        expected_output = {
            ...
            "lfm_auto_avg_cube_mid": 5,
            "lfm_auto_avg_cube_low": 7.5,
            "lfm_auto_avg_cube_total": 19,
            "lfm_tele_avg_cone_high": 3.5,
            "lfm_tele_avg_cone_mid": 7.5,
            "lfm_tele_avg_cone_low": 5,
            "lfm_tele_avg_cone_total": 16,
            "lfm_tele_avg_cube_high": 6.25,
            "lfm_tele_avg_cube_mid": 4,
        ...
        expected_results = [
            {
                ...
                "lfm_max_incap": 23,
                "lfm_max_auto_charge_level": "ENGAGE",
                "lfm_max_tele_charge_level": "PARK",
                # Modes
                "mode_preloaded_gamepiece": ["CONE"],
            ...
            },
            {
                ...
                "lfm_tele_avg_gamepieces": 41,
                "lfm_tele_avg_gamepieces_low": 9,
