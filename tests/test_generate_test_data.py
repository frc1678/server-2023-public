...
CORRECT_SCHEMA_DATAPOINT_COLLECTIONS = [
    # Obj Team
    {
        ...
        "mode_start_position": ["FOUR", "ONE"],
        "lfm_mode_start_position": ["FOUR", "ONE"],
        "mode_auto_charge_level": ["DOCK", "PARK"],
        "lfm_mode_auto_charge_level": ["DOCK", "PARK"],
        "mode_tele_charge_level": ["DOCK", "PARK"],
        "lfm_mode_tele_charge_level": ["DOCK", "PARK"],
        ...
        "max_tele_charge_level": "DOCK",
        "max_incap": 49,
        "max_auto_charge_level": "DOCK",
        "lfm_max_auto_charge_level": "DOCK",
        "lfm_max_incap": 49,
        "lfm_max_tele_charge_level": "DOCK",
